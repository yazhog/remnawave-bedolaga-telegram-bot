...
3) Синхранизацию с Remnawave между пользователями по тг id - In progress v1.2.0+
4) Полнофункциональную панель упарвления
5) Добавить возможность удаление промокодов - In progress v1.2.0+
6) Отправка уведомлений административных в другие чаты-топики
7) Рефка (как по мне беспонтовая штука, сервера нормальные хостите, сервис нормальный делайте и будет клиенты - не ебите мозги)
