...
> ℹ️ Если зависимости для RemnaWave (например, `aiohttp`) не установлены или интеграция не настроена, эндпоинты всё равно появятся в OpenAPI, но будут возвращать `503 Service Unavailable` с пояснением причины.
