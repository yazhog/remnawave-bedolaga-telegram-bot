...
class Config:
    ...
    TRIAL_WARNING_ENABLED: bool = True
    TRIAL_WARNING_HOURS_BEFORE: int = 2
    TRIAL_WARNING_HOURS_WINDOW: int = 6
...
def load_config() -> Config:
    ...
    return Config(
        ...
        TRIAL_WARNING_ENABLED=get_bool('TRIAL_WARNING_ENABLED', True),
        TRIAL_WARNING_HOURS_BEFORE=get_int('TRIAL_WARNING_HOURS_BEFORE', 2),
        TRIAL_WARNING_HOURS_WINDOW=get_int('TRIAL_WARNING_HOURS_WINDOW', 6),
