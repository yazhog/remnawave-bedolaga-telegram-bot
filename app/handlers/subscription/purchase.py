...
async def return_to_saved_cart(
    ...
    if settings.is_devices_selection_enabled() and cart_data.get('devices') is not None:
        summary_lines.append(f"📱 Устройства: {cart_data['devices']}")
    ...
    try:
        ...
        if existing_subscription:
            ...
            subscription = await create_paid_subscription_with_traffic_mode(
                ...
                device_limit=selected_devices if should_update_devices else None,
