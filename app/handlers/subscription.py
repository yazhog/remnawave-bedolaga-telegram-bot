...
from app.utils.promo_offer_display import (
    get_promo_offer_discount_percent,
...
async def _build_subscription_period_prompt(
    ...
    promo_offer_hint = await get_promo_offer_hint(db, db_user, texts)
    if promo_offer_hint:
...
async def handle_extend_subscription(
    ...
    renewal_prices = {}
    promo_offer_percent = get_promo_offer_discount_percent(db_user)
    ...
    promo_offer_hint = await get_promo_offer_hint(
        db,
        db_user,
        texts,
        promo_offer_percent,
...
async def confirm_purchase(
    ...
    current_promo_offer_percent = get_promo_offer_discount_percent(db_user)
