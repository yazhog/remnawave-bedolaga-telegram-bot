...
async def create_promo_offer_logs_table():
        ...
        async with engine.begin() as conn:
            ...
            if db_type == 'sqlite':
                ...
                CREATE TABLE promo_offer_logs (
                    ...
                    discount_value_kopeks INTEGER NULL,
                    metadata TEXT NULL,
                    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
                    FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE,
                ...
                CREATE INDEX ix_promo_offer_logs_user ON promo_offer_logs(user_id, created_at);
                CREATE INDEX ix_promo_offer_logs_action ON promo_offer_logs(action);
                """
            elif db_type == 'postgresql':
                create_sql = """
                ...
                CREATE INDEX IF NOT EXISTS ix_promo_offer_logs_user ON promo_offer_logs(user_id, created_at);
                CREATE INDEX IF NOT EXISTS ix_promo_offer_logs_action ON promo_offer_logs(action);
                """
            elif db_type == 'mysql':
                create_sql = """
                CREATE TABLE IF NOT EXISTS promo_offer_logs (
                    ...
                    source VARCHAR(100) NULL,
                    percent INT NULL,
                    discount_value_kopeks INT NULL,
                    metadata JSON NULL,
                    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
                    FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE,
                    FOREIGN KEY(offer_id) REFERENCES discount_offers(id) ON DELETE SET NULL
